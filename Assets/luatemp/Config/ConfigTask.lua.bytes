		...
		subTasks = {
			{
				subType = 1, sceneID=1001, contentID = 3001, content = {
					{who=3001, chat=[[我是中心村的，我们村来了很多魔鬼，你能帮我消灭他们吗?]], flag=1},
					{who=0, chat=[[好啊,没有问题，但是你能给我什么好处?]], flag=1}, 
					{who=3001, chat=[[我选举你做中心村的盟主+扛把子...]], flag=2},
				},
			},
			{-------flag=1是继续对话，2是接取下一个子任务，3是完成该系列子任务
				subType = 2, sceneID=1001, contentID=2005, maxProgress=10
			},
			{
				subType = 1, sceneID=1001, contentID = 3001, content = {
					{who=0, chat=[[我把怪物都打掉了,快叫我盟主吧]], flag=1},
					{who=3001, chat=[[盟主，扛把子...]], flag=3},
				},
			},
		},
	},
