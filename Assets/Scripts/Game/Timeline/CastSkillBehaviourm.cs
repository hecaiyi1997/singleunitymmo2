...
public class CastSkillBehaviourm : PlayableBehaviour
{
    ...
    {
        Debug.Log("===OnBehaviourPlayMMMMMMMM");
        ...
        //{
            ...
            if (trans != null)
            {
                ...
                /**********************************************************************************************/
                Dictionary<long, Entity> monsterdic = SceneMgr.Instance.GetSceneObjects(SceneObjectType.Role);
                var role=RoleMgr.GetInstance().GetMainRole().Entity;
                ...
                //{
                    ...
                    Debug.Log("OnBehaviourPlayMMMMMMMM=====" + dis);
                    if (dis < 10)
                    {
                        Debug.Log("OnBehaviourPlayMMMMMMMM" + dis);
