...
NetDispatcher.Event = {
    ...
    onApplyTalkExp = "NetDispatcher.Event.onApplyTalkExp",
    PlayAudioComplete = "NetDispatcher.Event.PlayAudioComplete",
    PlayAudioStart = "NetDispatcher.Event.PlayAudioStart",
}

function PlayAudioComplete() 
    print("PlayAudioComplete")
    GlobalEventSystem:Fire(NetDispatcher.Event.PlayAudioComplete)
end

function PlayAudioStart() 
    print("PlayAudioStart")
    GlobalEventSystem:Fire(NetDispatcher.Event.PlayAudioStart)
end

function onApplyTalkExp(typeID,uid) 
    print("Game onApplyTalkExp!",typeID,uid)
    GlobalEventSystem:Fire(NetDispatcher.Event.onApplyTalkExp,typeID,uid)
end
--当连接建立时
